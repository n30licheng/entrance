...
class  QssTitleBar : public QWidget
{
	Q_OBJECT
...
public:
    ...
    QssTitleBar(QWidget *parent, QTitleBar_Type type = QTitleBar_Type_MainWindow);
    ~QssTitleBar();
    ...
    bool getMaxOrRestore();
	QRect& normalRect(){return m_rcNormal;}
    void setTitleCenter(bool t);
private slots:
//slots:
	void onMaxOrRestore();
    void aboutMeslots();
...
public:
    QssMainWindow(QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::Widget);
    ...
    inline QssTitleBar* titleBar(){return m_titleBar;}
